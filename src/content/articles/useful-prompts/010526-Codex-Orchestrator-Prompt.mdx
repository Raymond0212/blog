...
This is a simple ***orchestration prompt*** to guide a ***agentic workflow*** with basic ***feedback loops***. I used it for my project [WhisperX UI](https://github.com/Raymond0212/WhisperX-UI) to guide agent orchestration. A better version should be giving more detailed sub-agent specific documentation including roles, rules, boundries and expected input/output formats, and more detailed workflow steps. But this is a good start for now and has been working well for simple projects.
